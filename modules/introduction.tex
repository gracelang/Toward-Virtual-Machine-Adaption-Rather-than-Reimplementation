...
Recently, \VM/ frameworks have emerged and are quickly becoming a core component to language implementation. \Truffle and \RPython are \VM/ frameworks: \Truffle [provides a host \VM/, which a developer uses to author a simple \AST interpreter and through doing so automatically gain features such as garbage collection, just-in-time compliation, and optimizations to the \AST; and \RPython geneartes \VM/s given \rr{(how to say this)}. Unsurprisingly, developers have already used these frameworks to successfully implement popular object-oriented programming languages (such as \Python, \Ruby, or \JavaScript), with performance results as good as state of the art \JITing \VM/s \citep{Marr2015,Marr:2016:AWFY}.
