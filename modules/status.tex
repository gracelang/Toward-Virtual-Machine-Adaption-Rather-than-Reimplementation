...
\begin{figure}
    ...
    \caption{The average running times for three harnessed benchmarks (with and without the Graal optimization layer are presented). Each benchmark was implemented equvilantely in both Grace and Newspeak. }
    \label{fig:benchmark}
\end{figure}
